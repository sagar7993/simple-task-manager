...
const AddUnsigned = (lX: number, lY: number): number => {
	let lX4: number; let lY4: number; let lX8: number; let lY8: number; let lResult: number;
	lX8 = (lX & 0x80000000);
	lY8 = (lY & 0x80000000);
	lX4 = (lX & 0x40000000);
	lY4 = (lY & 0x40000000);
...
const GG = (a: number, b: any, c: any, d: any, x: any, s: number, ac: number): number => {
	a = AddUnsigned(a, AddUnsigned(AddUnsigned(G(b, c, d), x), ac));
	return AddUnsigned(RotateLeft(a, s), b);
};

const HH = (a: number, b: any, c: any, d: any, x: any, s: number, ac: number): number => {
	a = AddUnsigned(a, AddUnsigned(AddUnsigned(H(b, c, d), x), ac));
	return AddUnsigned(RotateLeft(a, s), b);
};

const II = (a: number, b: any, c: any, d: any, x: any, s: number, ac: number): number => {
...
const WordToHex = (lValue: number): string => {
	let WordToHexValue = ''; let WordToHexValue_temp = ''; let lByte: number; let lCount: number;
...
const Utf8Encode = (input: string): string => {
	input = input.replace(/\r\n/g, '\n');
	let utftext = '';
...
export const MD5 = (input: string): string | null => {
	if (!input || input.length === 0) {
		return null;
	}
	let x = new Array<number>();
	let k: number; let AA: any; let BB: any; let CC: any; let DD: any;
