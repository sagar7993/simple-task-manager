		...
		<Box className="login-container">
			...
			<Box className="login-form-container">
				...
				<form className="login-form" onSubmit={(event: FormEvent) => { event.preventDefault(); handleLogin(); }}>
					...
					/>
					<Button variant="contained" type="submit" className="login-form-submit-button" disabled={loading}>Login</Button>
					<Button variant="text" type="button" className="login-form-navigate-button" disabled={loading} disableRipple={true} href={RoutePaths.Signup}>Don't have account?</Button>
				</form>
			</Box>
		</Box>
	);
